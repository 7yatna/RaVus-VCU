...
OBJSL		= $(BINARY).o hwinit.o stm32scheduler.o params.o terminal.o terminal_prj.o \
           my_string.o spiadc.o digio.o my_fp.o printf.o anain.o throttle.o isa_shunt.o BMW_E60.o GS450H.o temp_meas.o \
           BMW_E39.o Can_VAG.o Can_OI.o outlanderinverter.o canhardware.o canmap.o \
           param_save.o errormessage.o stm32_can.o leafinv.o utils.o terminalcommands.o i3LIM.o \
           amperacharger.o bmw_sbox.o NissanPDM.o teslaCharger.o extCharger.o vag_sbox.o \
		   ...
		   OutlanderHeartBeat.o leafbms.o V_Classic.o kangoobms.o OutlanderCanHeater.o NissLeafMng.o BatMan.o
