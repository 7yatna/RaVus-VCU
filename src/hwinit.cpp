...
void spi2_setup()   //spi 2 used for M3 BMS
{
	...
	spi_set_standard_mode(SPI2,3);//set mode 3
...
///PWM3
    ...
    {
        DigIo::Main_PWM3.Configure(GPIOB,GPIO0,PinMode::OUTPUT);
    }
    ...
    {
        DigIo::Main_PWM2.Configure(GPIOA,GPIO7,PinMode::OUTPUT);
    }
    ...
    {
        DigIo::Main_PWM1.Configure(GPIOA,GPIO6,PinMode::OUTPUT);
    }
